          ...
          <Card className="bg-white border border-[#051A24]/10 p-6 sm:p-8">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-[#051A24]">Copyright Notice</h1>
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h2 className="text-xl font-semibold text-[#051A24] mt-8 mb-4">Ownership</h2>
              ...
              <h2 className="text-xl font-semibold text-[#051A24] mt-8 mb-4">Application Content</h2>
              <p className="text-[#051A24]/70 mb-4">
              ...
              <h2 className="text-xl font-semibold text-[#051A24] mt-8 mb-4">Third-Party Content</h2>
              <p className="text-[#051A24]/70 mb-4">
              ...
              <h2 className="text-xl font-semibold text-[#051A24] mt-8 mb-4">NFT Ownership</h2>
              <p className="text-[#051A24]/70 mb-4">
              ...
              <h2 className="text-xl font-semibold text-[#051A24] mt-8 mb-4">Open Source Components</h2>
              <p className="text-[#051A24]/70 mb-4">
              ...
              <h2 className="text-xl font-semibold text-[#051A24] mt-8 mb-4">Legal Compliance</h2>
              <p className="text-[#051A24]/70 mb-4">
              ...
              <h2 className="text-xl font-semibold text-[#051A24] mt-8 mb-4">Contact</h2>
