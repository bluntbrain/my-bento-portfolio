...
export default function PrivacyPolicyPage() {
  ...
  return (
    <>
      <div className="ink min-h-screen p-4 sm:p-6">
        <div className="max-w-4xl mx-auto">
          <Card className="bg-white border border-[#051A24]/10 p-6 sm:p-8">
            {/* header */}
            <div className="flex items-center gap-4 mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-[#051A24]">Privacy Policy</h1>
                  <p className="text-[#051A24]/65 text-sm">OneSOL - Trading Terminal</p>
                </div>
              </div>
            </div>
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-[#051A24]/70 mb-6">
              ...
              <h2 className="text-xl font-semibold text-[#051A24] mt-8 mb-4">Information We Collect</h2>

              <h3 className="text-lg font-medium text-[#051A24] mt-6 mb-3">Wallet Information</h3>
              <p className="text-[#051A24]/70 mb-4">
              ...
              <h3 className="text-lg font-medium text-[#051A24] mt-6 mb-3">Local Storage</h3>
              <p className="text-[#051A24]/70 mb-4">
                We store the following data locally on your device:
              </p>
              <ul className="list-disc list-inside text-[#051A24]/70 space-y-2 mb-6">
              ...
              <h3 className="text-lg font-medium text-[#051A24] mt-6 mb-3">Blockchain Data</h3>
              <p className="text-[#051A24]/70 mb-4">
              ...
              <h2 className="text-xl font-semibold text-[#051A24] mt-8 mb-4">Third-Party Services</h2>
              <p className="text-[#051A24]/70 mb-4">
              ...
              <h2 className="text-xl font-semibold text-[#051A24] mt-8 mb-4">Information We Do NOT Collect</h2>
              <ul className="list-disc list-inside text-[#051A24]/70 space-y-2 mb-6">
              ...
              <h2 className="text-xl font-semibold text-[#051A24] mt-8 mb-4">Data Security</h2>
              <p className="text-[#051A24]/70 mb-4">
              ...
              <h2 className="text-xl font-semibold text-[#051A24] mt-8 mb-4">Your Rights</h2>
              <p className="text-[#051A24]/70 mb-4">
              ...
              <h2 className="text-xl font-semibold text-[#051A24] mt-8 mb-4">Children&apos;s Privacy</h2>
              <p className="text-[#051A24]/70 mb-4">
                OneSOL is not intended for use by children under 18. We do not knowingly
                collect information from children.
              </p>

              <h2 className="text-xl font-semibold text-[#051A24] mt-8 mb-4">Changes to This Policy</h2>
              <p className="text-[#051A24]/70 mb-4">
                We may update this Privacy Policy from time to time. Any changes will be
                reflected with an updated effective date at the top of this page.
              </p>

              <h2 className="text-xl font-semibold text-[#051A24] mt-8 mb-4">Contact Us</h2>
              <p className="text-[#051A24]/70">
                If you have questions about this Privacy Policy, please contact us at{" "}
                <a href="mailto:ishan.lakhwani@gmail.com" className="text-[#051A24] hover:underline">
